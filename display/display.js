...
function DisplayChallengeMode(){
    ...
    this.update = function(){
		...
		if(numCompetitors >= 1){
		    ...
		    var boxHeight = Math.floor(this.canvas.height / numCompetitors);
		    boxHeight = Math.min(boxHeight, this.canvas.height/15);
		    
		    // compute line positions
		    var curY = 0;
		    var firstDivider = midpointX + 35;
		    var secondDivider = midpointX + 150;
		    var thirdDivider = midpointX + 450;
		    ...
		    // draw first column divider (placement|name)
		    this.ctx.beginPath();
		    ...
		    // draw third column divider (editor|animation)
		    this.ctx.beginPath();
		        this.ctx.moveTo(thirdDivider, 0);
		        this.ctx.lineTo(thirdDivider, curY);
		        this.ctx.stroke();
		    this.ctx.closePath();
		}
